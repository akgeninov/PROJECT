        ...
        <div class="navigation">
            <ul>
                ...
                <li>
                    ...
                    <div class="list">
                        <ul>
                            <li><a href="../admin/view/tampilAdmin.php">Data Admin</a></li>
                            <li><a href="../admin/view/tampilPelanggan.php">Data Pelanggan</a></li>
                            <li><a href="../admin/view/tampilPegawai.php">Data Pegawai</a></li>
                            <li><a href="../admin/view/tampilKantor.php">Data Kantor</a></li>
                            <li><a href="../admin/view/tampilOrder.php">Data Pesanan</a></li>
                            <li><a href="../admin/view/tampilProduk.php">Data Produk</a></li>
                        </ul>
                    </div>
                </li>
                <li>

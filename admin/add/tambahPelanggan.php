                ...
                <ul>
                    ...
                    <div class="list">
                        <ul>
                            ...
                            <li><a href="../view/tampilOrder.php.php">Data Pesanan</a></li>
            ...
            <div class="main-content"> 
                ...
                <header>
                    ...
                    <?php
                        ...
                        if($status == "berhasil"){
                            echo "<script> alert('Berhasil menambahkan data pelanggan'); window.location='../view/tampilPelanggan.php';</script>";
                        }
                    ?>
                </main>
            </div>

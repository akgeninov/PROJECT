    ...
    <div className="flex flex-col max-w-[358px] md:max-w-[1080px]  w-full px-[5px] xl:px-0 justify-start items-center mt-[52px] ">
      <div className="w-full  flex flex-col justify-center items-start ">
        ...
        <div className="w-full  max-w-[695px] flex flex-col p-[28px]  border-[1px] rounded-[10px] border-black100">
          <div className="h-[606px] overflow-y-scroll  w-full pr-[17px] space-y-[12px] lg:space-y-[22px]">
            {tmpUlasan.map((el, index) => {
              const tanggalHariIni = new Date();

              const selisihMilisekon = el.tanggal - tanggalHariIni;

                    ...
                    <div className="w-full lg:w-full lg:h-[60px] h-[60px] flex mt-[20px] lg:mt-[20px]" style={{borderBottom: '2px solid #DEDEDE'}}>
                        <div className="lg:w-full w-full lg:h-full h:full ml-[20px] lg:ml-[20px] flex">
                            <p className="lg:mt-[5px] mt-[5px] text-[16px] lg:text-[16px] font-medium">Detail Pembelian</p>
                                <div className="w-[158px] lg:w-[158px] lg:h-[36px] h-[36px] rounded-[6px] lg:ml-auto ml-auto lg:mr-[20px] mr-[20px]  " style={{border: '1px solid #0F1011'}}>
                                    <div className="lg:flex flex px-[5px] lg:px-[5px]">
                                    <img 
                                        src={icon.COPY} 
                                        alt=""
                                        className="h-[15px] w-[15px] lg:h[15px] lg:w[15px] lg:mt-[8px] mt-[8px] ml-[5px]"
                                    />
                                    <p className="lg:mt-[4px] mt-[4px] lg:ml-[5px] ml-[5px] font-medium">

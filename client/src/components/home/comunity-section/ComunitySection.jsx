...
function ComunitySection() {
  return (
    <div className="gap-[50px] flex text-[100px] flex-col overflow-y-scroll justify-start items-center  py-[80px] bg-komunitySection bg-no-repeat px-[5px] sm:px-[100px]  w-full 2xl:max-w-[1280px] h-[832px] bg-cover  ">
        ...
        <div className="flex justify-center items-center">
          <div className="gap-[52px] flex flex-col ">
            <div className="flex flex-col w-[472px] gap-[16px]">
              <p className=" text-whiteSmoke500 text-[40px] font-bold leading-[60px]">

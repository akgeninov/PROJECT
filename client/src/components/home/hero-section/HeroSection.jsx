...
function HeroSection() {
  return (
    <div className="flex gap-[52px] h-[504px] justify-center items-center shrink-0 mt-[80px] mb-[80px]">
      <div className="flex flex-initial flex-col w-fit items-start gap-[52px] ">
        <div className="flex flex-col items-start gap-[16px] w-screen sm:w-[628px]">
        ...
        <button className="flex w-[260px] px-[64px] py-[18px] justify-center items-center bg-black500 rounded-[10px]">

...
function MainCheckout({ dataCheckout }) {
  ...
  return (
    ...
    >
            ...
            <div className="w-full lg:w-full lg:h-full h-full ml-[20px] lg:mt-[20px] lg:ml-[20px] mt-[20px]">
              ...
              >
                <div className="flex lg:ml-[20px] lg:flex ml-[20px] ">
                  ...
                  <div
                    className="w-[64px] lg:w-[64px] lg:h-[32px] lg:mt-[12px] lg:mr-[20px] lg:ml-auto lg:rounded-[6px] h-[32px] rounded-[6px] mt-[12px] ml-auto mr-[20px] "
          ...
          >
            ...
            >
              <div className=" w-full lg:w-full lg:h-full ml-[20px] lg:flex h-full lg:ml-[20px] flex">
                ...
                <div
                  className="w-[148px] lg:w-[148px] lg:h-[36px] lg:ml-auto lg:mr-[20px] h-[36px] rounded-[6px] ml-auto mr-[20px] "
                  style={{ border: "1px solid #0F1011" }}
                >
      ...
      <div
        className="w-[540px] lg:w-full lg:h-[96px] lg:mt-auto h-[96px] border mt-auto"
        style={{
          boxShadow: "4px 6px 8px rgba(0, 0, 0, 0.1)",
          border: "2px solid #DEDEDE",
        }}
